import { TailwindColors } from "@/types/colors";

export const colorMapping = (selectedColor: string = "slate") => ({
  border: {
    light: `${selectedColor}-200`,
    dark: `${selectedColor}-800`,
  },
  input: {
    light: `${selectedColor}-200`,
    dark: `${selectedColor}-800`,
  ...
  foreground: {
    light: `${selectedColor}-950`,
    dark: `${selectedColor}-50`,
  },
  muted: {
    light: `${selectedColor}-100`,
    dark: `${selectedColor}-800`,
  },
  "muted-foreground": {
    light: `${selectedColor}-500`,
    dark: `${selectedColor}-400`,
  },
  popover: {
    light: "white",
    dark: `${selectedColor}-950`,
  },
  "popover-foreground": {
    light: `${selectedColor}-950`,
    dark: `${selectedColor}-50`,
  ...
  primary: {
    light: `${selectedColor}-900`,
    dark: `${selectedColor}-50`,
  },
  "primary-foreground": {
    light: `${selectedColor}-50`,
    dark: `${selectedColor}-900`,
  },
  secondary: {
    light: `${selectedColor}-100`,
    dark: `${selectedColor}-800`,
